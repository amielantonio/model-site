        ...
        <main class="site-main" id="main">
            ...
            <section class="section--dates" id="">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-2">
                            <span class="text-primary h2">Now</span>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                            <span class="h2 text-primary">December 2024</span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-5">
                            <div>
                                <p>Model will be focusing on building a pipeline of 1,000 apartments in Melbourne with a development value of $500million.</p>
                            </div>
                            <div>
                                <div class="fs-110px text-primary mb-3"><span class="border-bottom border-primary">1,000 &nbsp;&nbsp;</span></div>
            ...
            <section class="section--dates section--dates-with-bg" id="">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            <span class="text-primary h2">December 2024</span>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="col-sm-4 text-end">
                            <span class="h2 text-primary text-end">Onwards</span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                        <div>
                                <p>After establishing our foothold in Melbourne, our focus will extend to developments in Sydney and the eastern seaboard.</p>
                            </div>
                        </div>
                        <!-- end col -->
            ...
            <section class="section--dates section--dates-lg bg-cream" id="">
                <div class="container">
                    ...
                    <div class="col-sm-4 text-end">
                            <span class="h2 text-primary text-end">By 2030</span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <div>
                                <div class="fs-110px text-primary mb-3"><span class="border-bottom border-primary">5,000 &nbsp;&nbsp;</span></div>
                                <div class="text-primary"><h4>Apartments</h4></div>
                                <div><p>In operation and/or under development by 2030</p></div>
                            </div>
                        </div>
                        <!-- end col -->

                        <div class="col-sm-6 offset-sm-1">
                            <p>To have 5,000 apartments in operation and/or under development across Australia - all of which will be pioneering global exemplars of decarbonised, connected communities.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="section--dates section--dates-lg" id="">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5">
                            <p class="h2 text-primary">Plans for expansion</p>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <div class="border-bottom border-2 border-primary pb-5">
                                <p>As both a developer and operator, Model will be creating a strong customer-focussed service ethic and brand. </p>

                                <p>Over time, we will look to scale out our operations platform and partner with other developers in the same way hotel managers do today.</p>
                            </div>
                        </div>
                        <!-- end col -->
            ...
            <section class="section--dates section--dates-lg bg-black" id="">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5">
                            <p class="h2 text-primary">Beyond Australia</p>
                        </div>
                        <div class="col-sm-7 text-end">
                            <svg width="730" height="15" viewBox="0 0 730 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M729.707 8.2071C730.098 7.81658 730.098 7.18341 729.707 6.79289L723.343 0.42893C722.953 0.0384056 722.319 0.0384057 721.929 0.42893C721.538 0.819455 721.538 1.45262 721.929 1.84314L727.586 7.5L721.929 13.1569C721.538 13.5474 721.538 14.1805 721.929 14.5711C722.319 14.9616 722.953 14.9616 723.343 14.5711L729.707 8.2071ZM8.74228e-08 8.50006L729 8.5L729 6.5L-8.74228e-08 6.50006L8.74228e-08 8.50006Z" fill="#CB6959"/>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-5">
                            <div class="border-bottom border-2 border-primary pb-5">
                                <p class="text-white">Once we have grown in reach and impression in Australia, we plan to launch in other key markets including New Zealand, United Kingdom and the United States.</p>
                            </div>
                        </div>
                        <!-- end col -->
